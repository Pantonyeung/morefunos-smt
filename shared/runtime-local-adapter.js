import {normalizeRuntimePayload,makeRuntimePatch} from './runtime-contract.js';
...
function write(value){
  const next=normalizeRuntimePayload(value);
...
export function createLocalRuntimeAdapter(){
  return Object.freeze({
    ...
    async push(patch,{expectedVersion=null,source='smt'}={}){
      ...
      const next=write(makeRuntimePatch(current,patch,{source}));
    ...
    reset(){localStorage.removeItem(STORAGE_KEY);return write({});}
  });
}
