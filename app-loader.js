import {createViewportFitter} from './shared/runtime.js?v=16c';
...
function load(){const key=route();if(key===current)return;current=key;frame.src=routes[key]+'?build=v16c';}
