...
Commit: 407fa186af6e3dd888cda3520c3f95341f019fa3
...
ok 3 - status separates automation from device acceptance
  ---
  duration_ms: 2.781624
  type: 'test'
  ...
# Subtest: cart adaptive scale must not shrink from cart height at 1920 baseline
not ok 4 - cart adaptive scale must not shrink from cart height at 1920 baseline
  ---
  duration_ms: 2.230563
  type: 'test'
  location: '/home/runner/work/morefunos-smt/morefunos-smt/tests/cart-adaptive-scale-contract.test.mjs:8:1'
  failureType: 'testCodeFailure'
  error: |-
    cart height must not be used as a second scale authority
  ...
  stack: |-
    TestContext.<anonymous> (file:///home/runner/work/morefunos-smt/morefunos-smt/tests/cart-adaptive-scale-contract.test.mjs:9:10)
...
not ok 227 - order overlay state stays event driven
  ---
  duration_ms: 1.756646
  type: 'test'
...
ok 228 - responsive profile writes are deduplicated per frame
  ---
  duration_ms: 0.270015
  type: 'test'
  ...
# Subtest: inactive preloaded pages do not keep overlay observers running
not ok 229 - inactive preloaded pages do not keep overlay observers running
  ---
  duration_ms: 1.281768
  type: 'test'
