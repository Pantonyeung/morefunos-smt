...
| D-051 | CURRENT | T2S 適配先在獨立公網分支以 1280×800 實際闊度驗收；保持原有資訊數量、點單三種卡四欄、圖片完整顯示、更多頁兩欄三行。公網確認前不得生成新安裝程式，自動測試及網站打印工作不得當作實體出紙 | 2026-07-22 最新產品確認／T2S public preview tests |
