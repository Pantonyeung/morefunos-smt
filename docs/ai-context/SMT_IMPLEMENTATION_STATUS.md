...
基準：`order-v1-26`／2026-07-22。

最新堂食第一版：獨立路由、九宮格枱面、掛單／取單雙面板、直接選枱正式落單、營運摘要枱卡、正式批次、打印工作及全數／逐餐品付款。堂食沒有暫存狀態；掃碼及枱碼保留為第二版入口。自動測試 106/106 通過，iPad／Sunmi T2S 待實機驗收。
...
| 更多頁六入口及安全確認 | 主畫面、六個細節面板、四個二次確認、本機顯示設定及真實待接通狀態已接入正式路由 | 通過；全套131／131 | 瀏覽器環境受阻，待 iPad Safari／T2S 實機驗收 | 內容 Lock／視覺待驗 |
