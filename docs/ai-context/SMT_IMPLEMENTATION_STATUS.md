...
基準：`order-v1-30`／2026-07-22。

最新營運核心：點單頁白屏啟動回歸已修正並加入可見錯誤後備；店舖接受面額、翌日開工現金、首頁營業分析、渠道／付款核數、三十分鐘歷史歸檔、分類搜尋設定及固定結帳操作已接通；五個主要頁面共用永久狀態欄、底部導航、選擇膠囊及四方向來源箭嘴；四類打印資料已按實物標籤補齊。完整自動測試 189／189及首次渲染通過；安卓原生橋接、實體出紙與 iPad／Sunmi T2S 視覺待驗收。
