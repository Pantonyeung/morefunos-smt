...
基準：`order-v1-28`／2026-07-22。

最新營運核心：日結面額雙向盤點、提取／留底守恆、待核實款項反推及 3% 授權稽核已接通；堂食點單只在正式提交時開枱，取消及清枱會清除殘留脈絡；全局短動效及減少動效模式已套用。完整自動測試 168／168 通過；安卓原生橋接、實體出紙與 iPad／Sunmi T2S 視覺待驗收。
...
| 更多頁六入口及安全確認 | 日結含港幣面額雙向盤點、提取／留底、待核實現金／非現金反推及淨銷售 3% 授權；其餘本機報表、備份、顯示、診斷、打印中心及安全確認維持接通 | 通過；全套168／168 | 待 iPad Safari／T2S 實機驗收 | 資料／流程 Lock；視覺待驗 |
