...
更新：2026-07-20｜分支：`feat/smt-order-page-v1`｜程式：`order-v1-10`
最新自動驗證：42/42 通過｜產品狀態：iPad／Sunmi T2S 最終 Lock 尚未完成
...
- 程式及自動測試已有：單一卡片、購物車分組與圖片開關、普通／快捷模式、飲品多配置、動態配對、待處理核對、付款證明、WhatsApp QR、售罄預覽、設備／線上卡、新單提示。
- 最新一輪：購物車右對齊、A–Z 動態配對、共用飲品卡、快捷飲品 150×240／344px 抽屜。
- 不可宣稱完成：真實訂單 API、付款證明上載 API、打印／設備、iPad Safari、Sunmi T2S、產品負責人最終 Lock。
