...
更新：2026-07-22｜分支：`feat/smt-order-page-v1`｜程式：`order-v1-29`
最新自動驗證：186/186 通過｜產品狀態：真機回饋整合修正、統一介面骨架、三十分鐘歷史歸檔、分類搜尋設定、首頁分析及四類打印資料已完成；安卓橋接、實體出紙與 iPad／Sunmi T2S 視覺待驗收
...
- 點單頁基礎狀態欄為永久全域狀態欄，所有主要頁不可刪除；頁面專用狀態只可附加。底部五項導航共用同一元件，內容區內滾動。
