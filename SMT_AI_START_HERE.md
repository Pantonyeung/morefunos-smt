...
更新：2026-07-22｜分支：`feat/smt-order-page-v1`｜程式：`order-v1-25`
最新自動驗證：124/124 通過｜產品狀態：售罄／停售、小圖、掛單、取單、堂食及結帳介面待 iPad／Sunmi T2S 實機驗收
...
- 不可宣稱完成：真實訂單提交 API、掃碼會話 API、付款閘道、打印／設備、餐牌 API 實機驗收、iPad Safari、Sunmi T2S、產品負責人最終 Lock。
