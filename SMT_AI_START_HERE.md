...
更新：2026-07-22｜分支：`test/t2s-display-adaptation`｜程式：`order-v1-31-t2s-preview.1`
最新自動驗證：225/225 通過｜產品狀態：T2S 公網適配已加入實際闊度、四欄卡、後備圖片及安全區，正等待 1280×800 實機驗收；跨實體終端原子派號、安卓橋接及實體出紙仍待後台／安裝程式驗證
