...
更新：2026-07-22｜分支：`feat/smt-order-page-v1`｜程式：`order-v1-30`
最新自動驗證：189/189 及首次渲染通過｜產品狀態：點單白屏啟動錯誤已修正並加入可見後備畫面；真機回饋整合、統一介面骨架及選擇膠囊、三十分鐘歷史歸檔、分類搜尋設定、首頁分析及四類打印資料已完成；安卓橋接、實體出紙與 iPad／Sunmi T2S 視覺待驗收
