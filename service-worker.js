const CACHE='morefun-smt-shell-v1-20260729';
const CORE=[
  ...
  './shared/runtime-contract.js','./shared/runtime-local-adapter.js','./shared/runtime-controller.js','./shared/runtime-bootstrap.js','./shared/runtime-lifecycle.js','./shared/runtime-status.js','./shared/runtime-diagnostics.js','./shared/runtime-snapshot-store.js','./shared/push-queue.js','./shared/health-state.js','./shared/offline-package-store.js','./shared/offline-survival.js',
  ...
  './pages/more/index.html','./pages/more/page.js','./pages/more/page.css','./pages/more/responsive.css','./pages/more/more-domain.js','./pages/more/print-domain.js'
];
