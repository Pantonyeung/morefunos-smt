const CACHE = 'morefun-smt-concept-replica-v3';
const CORE_ASSETS = [
  ...
  './app.js','./replica-runtime-fixes.js','./smt-data.js','./smt-copy.js','./smt-domain.js','./smt-state.js','./smt-icons.js','./smt-motion.js','./smt-views.js','./manifest.webmanifest'
];
