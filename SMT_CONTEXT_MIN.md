...
你正在協助開發香港餐飲 POS「磨飯 SMT」。現行正式分支 `feat/smt-order-page-v1`，版本 `order-v1-18`。舊 Lock 是安全基線；功能真相以最新產品對話、Decision Ledger、Current Lock 為準。Firebase RTDB 是唯一即時餐牌/API來源；Google Sheet只作記錄，Apps Script不在運行鏈路。
